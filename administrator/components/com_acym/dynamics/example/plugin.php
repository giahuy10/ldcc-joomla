...
class plgAcymExample extends acymPlugin
{
    ...
    function insertOptions()
    {
        ...
        $plugins->name = 'CBuilder';
        $plugins->title = 'Community Builder';
    ...
    function popup()
    {
        ...
        $result->options[] = acym_radio($typeinfo, 'typeinfo', 'receiver');
        ...
        foreach ($fields as $fieldname) {
            ...
            $text .= '<div class="cell acym__listing__row acym__listing__row__popup" onclick="applyCB(\''.$fieldname.$type.'\');" >'.$fieldname.'</div>';
        }

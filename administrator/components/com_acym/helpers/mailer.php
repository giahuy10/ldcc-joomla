...
class acymmailerHelper extends acyPHPMailer
{
    ...
    public function send()
    {
        ...
        if ($this->ContentType != 'text/plain') {
            ...
            $finalContent .= '</head><body>'.$this->Body.'</body></html>';
    ...
    public function sendOne($mailId, $user)
    {
        $this->clearAll();
    ...
    {
        $pictureLink = acym_frontendLink('frontstats&action=acym_frontrouter&task=openStats&id='.$mailId.'&userid='.$userId);

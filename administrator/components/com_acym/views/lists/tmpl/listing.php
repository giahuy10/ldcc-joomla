    ...
    <div id="acym__lists" class="acym__content">
        ...
        <?php } else { ?>
            ...
            <?php if (empty($data['lists'])) { ?>
                <h1 class="cell acym__listing__empty__search__title text-center"><?php echo acym_translation_sprintf('ACYM_NO_X_FOUND', strtolower(acym_translation('ACYM_LIST'))); ?></h1>
            <?php } else { ?>
                    ...
                    <?php foreach ($data["lists"] as $list) { ?>
                        <div elementid="<?php echo htmlspecialchars($list->id); ?>" class="grid-x cell acym__listing__row">
                            ...
                            <div class="grid-x medium-auto small-11 cell margin-left-2">
                                ...
                                <div class="xxlarge-2 medium-3 medium-up-1 small-up-3 cell acym__listing__controls acym__lists__controls grid-x">
                                    ...
                                    <h6 class="cell show-for-small-only text-center"><?php echo acym_translation('ACYM_ID'); ?> : <?php echo htmlspecialchars($list->id); ?></h6>
                                </div>

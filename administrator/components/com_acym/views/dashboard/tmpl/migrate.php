	...
	<div id="acym_migrate" class="cell grid-x">
		...
		<div class="acym__content__reduced cell large-6 grid-x">
			...
			<div class="cell grid-x text-center">
				...
				<button type="submit" data-task="migrationDone" class="button button-secondary acy_button_submit margin-right-1 cell medium-shrink" id="acym__migrate__no__button"><?php echo acym_translation("ACYM_NO_DONT_WANT_TO_MIGRATE_MY_DATA") ?></button>
				<button type="button" class="button primary cell medium-shrink" id="acym__migrate__button"><?php echo acym_translation("ACYM_MIGRATE") ?></button>
			</div>
			...
			<div class="cell acym__color__red grid-x" id="acym__migrate__result__error">
				...
				<button type="submit" data-task="migrationDone" class="button button-secondary cell acy_button_submit medium-shrink"><?php echo acym_translation("ACYM_IGNORE_ERRORS_AND_CONTINUE") ?></button>
			</div>
		</div>
		<div class="cell large-3"></div>
	</div>

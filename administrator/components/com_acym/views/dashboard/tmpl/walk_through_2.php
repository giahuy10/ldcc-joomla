...
<div id="acym_walk-through_2" class="cell grid-x">
	...
	<div class="cell grid-x large-6 small-12 acym__walk-through-2__content">
		...
		<div class="cell grid-x acym__content cell text-center">
			...
			<p class="cell acym__walk-through-2__send-question"><?php echo acym_translation('ACYM_HOW_DO_YOU_WANT_TO_SEND_YOUT_MAIL'); ?></p>
			...
			<div class="cell grid-x acym__walk-through-2__choose_your-server" <?php echo $data['use_server'] ? '' : 'style="display:none"' ?>>
				...
				<div class="medium-3"></div>
				<div class="medium-3"></div>
				<button id="sendmail" class="cell medium-6 acym__walk-through-2__button button <?php echo ($data['use_server'] && $data['mailer_method'] != 'sendmail') || !$data['use_server'] ? 'unselected' : 'your_server_selected' ?>"><?php echo acym_translation('ACYM_SEND_MAIL'); ?></button>
				<div class="medium-3"></div>
				<div class="medium-3"></div>
				<button id="qmail" class="cell medium-6 acym__walk-through-2__button button <?php echo ($data['use_server'] && $data['mailer_method'] != 'qmail') || !$data['use_server'] ? 'unselected' : 'your_server_selected' ?>"><?php echo acym_translation('ACYM_QMAIL'); ?></button>
				<div class="medium-3"></div>
			</div>
			<div class="cell grid-x acym__walk-through-2__choose_external-server" <?php echo $data['use_server'] ? 'style="display:none"' : '' ?>>
				...
				<span id="elasticemail" class="shrink acym__walk_through_toggle-span <?php echo (!$data['use_server'] && $data['mailer_method'] == 'smtp') || $data['use_server'] ? '' : 'walk-through_selected'; ?>"><?php echo acym_translation('ACYM_ELASTIC_EMAIL'); ?></span>
				<div class="cell grid-x acym__walk-through-2__smtp-server" <?php echo (!$data['use_server'] && $data['mailer_method'] == 'smtp') || $data['use_server'] ? '' : 'style="display:none"'; ?>>
					<label for="acym__walk-through-2__smtp_server" class="cell text-left acym__walk-through__content__label"><?php echo acym_translation('ACYM_SERVER'); ?></label>
					...
					<label for="acym__walk-through-2__smtp_port" class="cell text-left acym__walk-through__content__label"><?php echo acym_translation('ACYM_PORT'); ?></label>
					<input <?php echo empty($data['smtp_port']) ? '' : 'value="'.$data['smtp_port'].'"' ?> type="text" class="input-group-field cell" name="smtp[port]" id="acym__walk-through-2__smtp_port" placeholder="<?php echo acym_translation('ACYM_PORT'); ?>">
					...
					<div class="cell medium-6 grid-x">
                        <?php echo acym_switch('smtp[keepalive]', empty($data['smtp_keepalive']) ? '0' : '1', acym_translation('ACYM_KEEP_ALIVE')); ?>
					</div>
					<div class="cell medium-6 grid-x">
                        <?php echo acym_switch('smtp[auth]', empty($data['smtp_auth']) ? '0' : '1', acym_translation('ACYM_AUTHENTICATION')); ?>
					</div>
					<label for="acym__walk-through-2__smtp_username" class="cell text-left acym__walk-through__content__label"><?php echo acym_translation('ACYM_USERNAME'); ?></label>
					<input <?php echo empty($data['smtp_username']) ? '' : 'value="'.$data['smtp_username'].'"' ?> type="text" class="input-group-field cell" name="smtp[username]" id="acym__walk-through-2__smtp_username" placeholder="<?php echo acym_translation('ACYM_USERNAME'); ?>">
					<label for="acym__walk-through-2__smtp_password" class="cell text-left acym__walk-through__content__label"><?php echo acym_translation('ACYM_PASSWORD'); ?></label>
					<input <?php echo empty($data['smtp_password']) ? '' : 'value="'.str_repeat('*', strlen($data['smtp_password'])).'"' ?> type="text" class="input-group-field cell" name="smtp[password]" id="acym__walk-through-2__smtp_password" placeholder="<?php echo acym_translation('ACYM_PASSWORD'); ?>">
				</div>
				<div class="cell grid-x acym__walk-through-2__elastic-email" <?php echo !$data['use_server'] && $data['mailer_method'] == 'smtp' ? 'style="display:none"' : ''; ?> <?php echo $data['use_server'] ? 'style="display:none"' : ''; ?>>
					<label for="acym__walk-through-2__elastic_username" class="cell text-left acym__walk-through__content__label"><?php echo acym_translation('ACYM_USERNAME'); ?></label>
					<input <?php echo empty($data['elasticemail_username']) ? '' : 'value="'.$data['elasticemail_username'].'"' ?> type="text" class="input-group-field cell" name="elastic[username]" id="acym__walk-through-2__elastic_username" placeholder="<?php echo acym_translation('ACYM_USERNAME'); ?>">
					<label for="acym__walk-through-2__elastic_password" class="cell text-left acym__walk-through__content__label"><?php echo acym_translation('ACYM_PASSWORD'); ?></label>
					<input <?php echo empty($data['elasticemail_password']) ? '' : 'value="'.$data['elasticemail_password'].'"' ?> type="text" class="input-group-field cell" name="elastic[password]" id="acym__walk-through-2__elastic_password" placeholder="<?php echo acym_translation('ACYM_PASSWORD'); ?>">
					<div class="cell medium-up-2 grid-x acym__walk-through-2__elastic_port">
						<span><?php echo acym_translation('ACYM_PORT'); ?></span>
                        <?php
                        $ports = array(
                            '25' => '25',
                            '2525' => '2525',

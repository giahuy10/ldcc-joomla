    ...
    <div id="acym__users" class="acym__content">
        ...
        <?php } else { ?>
            ...
            <?php if (empty($data['allUsers'])) { ?>
                <h1 class="cell acym__listing__empty__search__title text-center"><?php echo acym_translation_sprintf('ACYM_NO_X_FOUND', strtolower(acym_translation('ACYM_USER'))); ?></h1>
            <?php } else { ?>
                            ...
                            <div class="grid-x medium-auto small-11 cell margin-left-2">
                                ...
                                if (!empty($user->fields)) {
                                    foreach ($user->fields as $field) {
                                        ?>
                                        <div class="medium-auto small-11 cell">
                                            <?php echo htmlspecialchars($field); ?>
                                        </div>
                                        <?php
                                    }
                                ...
                                <h6 class="text-center medium-1 small-2 acym__listing__text"><?php echo htmlspecialchars($user->id) ?></h6>
                            </div>
                        </div>
                        <?php
                    }

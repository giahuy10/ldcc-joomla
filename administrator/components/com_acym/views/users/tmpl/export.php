        ...
        <div class="cell grid-x grid-margin-x">
            <div class="cell acym_area medium-6 acym__content">
                ...
                <fieldset class="margin-bottom-1">
                    <?php
                    echo acym_radio([';' => acym_translation('ACYM_SEMICOLON'), ',' => acym_translation('ACYM_COMMA')], 'export_separator', $data['config']->get('export_separator', ','), null, array(), 'value', 'text', true);
                    ?>
                </fieldset>
                ...
                <div class="margin-bottom-1">
                    ...
                    foreach ($data['fields'] as $fieldName) {
                        ...
                        echo '<input '.$checked.' id="checkbox_'.$fieldName.'" class="acym__users__export__export_fields smaller-checkbox" type="checkbox" name="export_fields[]" value="'.$fieldName.'"><label for="checkbox_'.$fieldName.'">'.$fieldName.'</label><br/>';
                    } ?>
                </div>
                <div class="grid-x">
                    <label class="cell large-4 medium-6"><?php echo acym_translation('ACYM_ENCODING') ?>

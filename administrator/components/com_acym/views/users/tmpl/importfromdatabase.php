    ...
    <div class="cell large-6 grid-x">
        ...
        if (!empty($userFields)) {
            foreach ($userFields as $oneUserField) {
                if (!in_array($oneUserField, ["id", "active", "creation_date", "cms_id", "source", "confirmed", "key"])) {
        ...
        <div class="cell grid-x">
            ...
            <button type="button" class="button acym__import__submit cell medium-shrink" data-from="database"><?php echo acym_translation('ACYM_IMPORT') ?></button>
        </div>
    </div>
    <div class="cell large-3"></div>
</div>

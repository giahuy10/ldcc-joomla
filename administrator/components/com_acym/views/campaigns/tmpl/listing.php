	...
	<div id="acym__campaigns" class="acym__content">
        ...
        <?php } else { ?>
            ...
            <?php if (empty($data['allCampaigns'])) { ?>
				<h1 class="cell acym__listing__empty__search__title text-center"><?php echo acym_translation_sprintf('ACYM_NO_X_FOUND', strtolower(acym_translation('ACYM_CAMPAIGN'))); ?></h1>
            <?php } else { ?>
				...
				<div class="grid-x acym__listing">
					<div class="grid-x cell acym__listing__header">
						...
						<div class="grid-x medium-auto small-11 cell margin-left-2">
							...
							<div class="small-1 cell text-center acym__listing__header__title">
                    ...
                    foreach ($data['allCampaigns'] as $campaign) {
						...
						<div class="grid-x cell acym__listing__row">
							...
							<div class="grid-x medium-auto small-11 cell acym__campaign__listing margin-left-2">
								...
								<div class="large-3 medium-3 small-5 cell">
                                    ...
                                    if (!empty($campaign->lists)) {
                                        ...
                                        echo '<div class="cell medium-12">'.acym_translation('ACYM_NO_LIST_SELECTED').'</div>';
                                    }
                                    ?>
								</div>
								...
								<h6 class="large-1 medium-1 small-1 cell text-center acym__listing__text"><?php echo htmlspecialchars($campaign->id) ?></h6>
							</div>
						</div>
                        <?php
                    }

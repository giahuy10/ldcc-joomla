...
?><div class="acym__content acym_area padding-vertical-1 padding-horizontal-2 margin-bottom-2">
    ...
    <div class="grid-x grid-margin-x">
        ...
        <div class="cell medium-6 grid-x">
            ...
            <input class="cell large-9" id="security_key" type="text" name="config[security_key]" value="<?php echo $data['config']->get('security_key'); ?>"/>
        </div>
        <div class="cell medium-6 grid-x">
            ...
            <input class="cell large-9" id="recaptcha_sitekey" type="text" name="config[recaptcha_sitekey]" value="<?php echo $data['config']->get('recaptcha_sitekey'); ?>"/>
        </div>
        <div class="cell medium-6 grid-x">
            ...
            <input class="cell large-9" id="recaptcha_secretkey" type="text" name="config[recaptcha_secretkey]" value="<?php echo $data['config']->get('recaptcha_secretkey'); ?>"/>
        </div>
    </div>
</div>
...
<div class="acym__content acym_area padding-vertical-1 padding-horizontal-2 margin-bottom-2">
    ...
    <div class="grid-x grid-margin-x">
        <div class="cell medium-6 grid-x">
            ...
            <input class="cell large-9" id="allowed_files" type="text" name="config[allowed_files]" value="<?php echo $data['config']->get('allowed_files'); ?>"/>
        </div>
    </div>
    <div class="grid-x grid-margin-x">
        <div class="cell medium-6 grid-x">
            ...
            <input class="cell large-9" id="uploadfolder" type="text" name="config[uploadfolder]" value="<?php echo $data['config']->get('uploadfolder'); ?>"/>
        </div>
    </div>
</div>
...
<div class="acym__configuration__check-database acym__content acym_area padding-vertical-1 padding-horizontal-2">
    ...
    <div class="grid-x grid-margin-x">
        <div class="cell medium-shrink">
            <button type="button" class="button" id="checkdb_button"><?php echo acym_translation('ACYM_CHECK_DB'); ?></button>
        </div>

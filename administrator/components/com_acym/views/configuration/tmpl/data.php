...
?><div class="acym__content acym_area padding-vertical-1 padding-horizontal-2 margin-bottom-2">
    ...
    <div class="grid-x grid-margin-x">
        <?php echo acym_switch('config[gdpr_delete]', $data['config']->get('gdpr_delete'), acym_translation('ACYM_GDPR_DELETE_BUTTON'), array(), 'xlarge-3 medium-5 small-9', "auto", "tiny", 'delete_config'); ?>
    </div>
</div>

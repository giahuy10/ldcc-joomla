...
CREATE TABLE IF NOT EXISTS `#__acym_step` (
    ...
    INDEX `fk_#__acym_step_has_mail1` (`mail_id` ASC),
    CONSTRAINT `fk_#__acym_step_has_mail1`
    FOREIGN KEY (`mail_id`)
    REFERENCES `#__acym_mail` (`id`)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `#__acym_automation_has_step` (
    `automation_id` INT NOT NULL,
    `step_id` INT NOT NULL,
    `order` INT NULL,
    PRIMARY KEY (`automation_id`, `step_id`),
    INDEX `fk_#__acym_automation_step1` (`step_id` ASC),
    INDEX `fk_#__acym_automation_step2` (`automation_id` ASC),
    CONSTRAINT `fk_#__acym_automation_has_step1`
    FOREIGN KEY (`automation_id`)
    REFERENCES `#__acym_automation` (`id`)
        ON DELETE NO ACTION
        ON UPDATE NO ACTION,
    CONSTRAINT `fk_#__acym_automation_has_step2`
    FOREIGN KEY (`step_id`)

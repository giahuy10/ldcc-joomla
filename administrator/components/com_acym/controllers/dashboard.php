...
class DashboardController extends acymController
{
    ...
    function listing()
    {
        ...
        if ($config->get("migration") == 0 && $this->existsAcyMailing59()) {
    ...
    function migrate()
    {
        ...
        $result = $helperMigration->$functionName();
    ...
    private function existsAcyMailing59()
    {

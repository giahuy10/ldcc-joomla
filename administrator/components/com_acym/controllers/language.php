...
class LanguageController extends acymController
{
    ...
    public function saveLanguage($fromShare = false)
    {
        ...
        if ($result) {
            ...
            $js = "window.top.document.getElementById('image$code').innerHTML = 'edit'";
    ...
    function send()
    {
        ...
        $file = acym_getLanguagePath(ACYM_ROOT, $code).DS.$code.'.com_acym_custom.ini';
        if (!file_exists($file)) {
            return;
        }

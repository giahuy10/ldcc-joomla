...
class ListsController extends acymController
{
    ...
    public function setAjaxListing()
    {
        ...
        if (empty($lists['lists'])) {
            $return .= '<h1 class="cell acym__listing__empty__search__modal text-center">'.acym_translation_sprintf('ACYM_NO_X_FOUND', strtolower(acym_translation('ACYM_LIST'))).'</h1>';
        }
